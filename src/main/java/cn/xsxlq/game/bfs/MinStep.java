...
//        snakeList.removeLast();
        ...
        List<PointDto> parentList = new LinkedList<>();
        List<PointDto> childList = new LinkedList<>();
...
//        if(!allList.getLast().getPoint().equals(targetPoint)){
//            allList.clear();
//        }
        ...
        return getDirList(allList.getLast());
    }
